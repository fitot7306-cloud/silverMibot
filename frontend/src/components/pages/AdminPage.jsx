      ...
      <div style={{
        ...
        {visibleTabs.map(t => (
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            boxShadow: tab === t.id ? '0 4px 12px rgba(52,211,153,0.3)' : 'none',
...
function Dashboard() {
  ...
  return (
    <div>
      ...
      {/* 🛒 Buyers vs Free */}
      {stats.buyers && (
        <div className="card" style={{ padding: 14, marginBottom: 16, border: '1px solid rgba(52,211,153,0.15)', animation: 'fadeIn 0.3s ease' }}>
                ...
                <div key={u.id} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <div style={{
                      ...
                      background: i < 3 ? 'rgba(52,211,153,0.15)' : 'rgba(255,255,255,0.05)',
      ...
      {/* 💰 Finance Analytics */}
      {stats.finance && (
        <div className="card" style={{ padding: 16, marginBottom: 16, border: '1px solid rgba(52,211,153,0.2)', animation: 'fadeIn 0.3s ease' }}>
          ...
          {/* ⚡ Mining Forecast */}
          <div style={{ padding: 12, borderRadius: 10, background: 'rgba(52,211,153,0.04)', border: '1px solid rgba(52,211,153,0.15)', marginBottom: 12 }}>
...
function WithdrawalsPanel() {
  ...
  return (
    <div>
      ...
      <div className="card" style={{ padding: 16, marginBottom: 16, border: '1px solid rgba(52,211,153,0.2)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
              ...
              {g.has_admin && <span style={{ fontSize: 8, padding: '1px 5px', borderRadius: 4, background: 'rgba(52,211,153,0.15)', color: 'var(--primary)', fontWeight: 700 }}>👑 ADMIN</span>}
        ...
        <div style={{ padding: '0 14px 14px', display: 'flex', flexDirection: 'column', gap: 6, animation: 'fadeIn 0.2s ease' }}>
          {g.users.map(u => (
            <div key={u.id} style={{
              ...
              background: u.is_admin ? 'rgba(52,211,153,0.06)' : u.is_blocked ? 'rgba(248,113,113,0.08)' : 'rgba(255,255,255,0.03)',
              border: u.is_admin ? '1px solid rgba(52,211,153,0.25)' : u.is_blocked ? '1px solid rgba(248,113,113,0.2)' : '1px solid var(--border)',
            }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
                  <div style={{ fontSize: 13, fontWeight: 700 }}>
                    ...
                    {u.is_admin && <span style={{ fontSize: 8, marginLeft: 6, padding: '1px 5px', borderRadius: 4, background: 'rgba(52,211,153,0.15)', color: 'var(--primary)', fontWeight: 700 }}>👑</span>}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 4, marginBottom: 12 }}>
        {[
          ...
          <button key={t.id} onClick={() => setSubTab(t.id)} style={{
            ...
            background: subTab === t.id ? 'rgba(52,211,153,0.15)' : 'rgba(255,255,255,0.04)',
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 6, marginBottom: 10 }}>
        {['HTML', 'Markdown', 'Plain'].map(m => (
          <button key={m} onClick={() => setParseMode(m === 'Plain' ? '' : m)} style={{
            ...
            background: (parseMode === m || (m === 'Plain' && !parseMode)) ? 'rgba(52,211,153,0.15)' : 'rgba(255,255,255,0.04)',
      ...
      <label onClick={() => setIsRtl(!isRtl)} style={{
        ...
        background: isRtl ? 'rgba(52,211,153,0.12)' : 'rgba(255,255,255,0.04)',
        border: isRtl ? '1px solid rgba(52,211,153,0.3)' : '1px solid var(--border)',
        transition: 'all 0.2s ease',
      }}>
        <div style={{
      ...
      {sending && progress && progress.status === 'sending' && (
        <div className="card" style={{ marginTop: 12, padding: 14, border: '1px solid rgba(52,211,153,0.3)', animation: 'fadeIn 0.3s ease' }}>
          ...
          {result.error ? (
            ...
            <div>
              ...
              {(result.blocked_auto > 0 || result.blocked_skipped > 0) && (
                <div style={{ marginTop: 10, padding: 10, background: 'rgba(52,211,153,0.06)', borderRadius: 8 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        {admins.map((a, i) => (
          <div key={a.tg_id} className="card" style={{
            padding: '14px', animation: `fadeIn 0.3s ease ${i * 0.04}s both`,
            border: a.is_env ? '1px solid rgba(52,211,153,0.3)' : '1px solid var(--border)',
          }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 3, marginTop: 4 }}>
                    {a.permissions === '*' ? (
                      <span style={{ fontSize: 9, padding: '1px 6px', borderRadius: 4, background: 'rgba(52,211,153,0.15)', color: 'var(--primary)', fontWeight: 700 }}>
                        ✦ Полный доступ
                      </span>
                ...
                {!a.is_env && (
                  <>
                    <button onClick={() => editPerms === a.tg_id ? setEditPerms(null) : startEditPerms(a)} style={{
                      background: editPerms === a.tg_id ? 'rgba(52,211,153,0.15)' : 'rgba(255,255,255,0.04)',
          ...
          {(title || text || imagePreview) && (
            <div style={{ marginBottom: 12 }}>
              ...
              <div style={{
                ...
                background: 'linear-gradient(135deg, rgba(52,211,153,0.05), rgba(0,0,0,0.2))',
              ...
              <>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                  ...
                  <button onClick={() => setPreviewId(previewId === p.id ? null : p.id)} style={{
                    padding: '4px 10px', borderRadius: 8, border: '1px solid rgba(52,211,153,0.2)',
                    background: previewId === p.id ? 'rgba(52,211,153,0.1)' : 'transparent',
                ...
                {previewId === p.id && (
                  <div style={{ padding:14, borderRadius:12, marginBottom:10, background:'linear-gradient(135deg, rgba(52,211,153,0.05), rgba(0,0,0,0.2))', border:'1px solid rgba(52,211,153,0.15)', animation:'fadeIn 0.3s ease' }}>
        ...
        <div className="card" style={{ marginBottom: 14, animation: 'fadeIn 0.3s ease' }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
            ...
            <button onClick={() => {
              ...
              padding: '10px 14px', borderRadius: 10, border: '1px solid rgba(52,211,153,0.2)',
              background: 'rgba(52,211,153,0.08)', color: 'var(--primary)',
          ...
          return (
            <div key={p.id} className="card" style={{ padding: 14, animation: `fadeIn 0.3s ease ${i * 0.04}s both`, opacity: (!p.is_active || expired || exhausted) ? 0.5 : 1 }}>
              ...
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 10 }}>
                ...
                <span style={{ fontSize: 9, padding: '2px 6px', borderRadius: 6, background: 'rgba(52,211,153,0.1)', color: 'var(--primary)', fontWeight: 600 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    {d.package_name && <span style={{ fontSize: 9, padding: '2px 6px', borderRadius: 6, background: 'rgba(52,211,153,0.1)', color: 'var(--primary)', fontWeight: 600 }}>📦 {d.package_name}</span>}
                    {d.promo_code && (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                        ...
                        {p.package_name && <span style={{ fontSize: 9, padding: '2px 6px', borderRadius: 6, background: 'rgba(52,211,153,0.1)', color: 'var(--primary)', fontWeight: 600 }}>📦 {p.package_name}</span>}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        {logs.map((l, i) => (
          <div key={l.id} className="card" style={{
            ...
            borderLeft: l.action === 'view_tab' ? '3px solid rgba(52,211,153,0.3)' : '3px solid rgba(52,211,153,0.3)',
          }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
