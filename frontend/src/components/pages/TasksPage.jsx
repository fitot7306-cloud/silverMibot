      ...
      {adAvailable && (
        <div style={{ marginBottom: 20 }}>
          ...
          <div className="card" style={{
            padding: '16px 18px', border: '1px solid rgba(192,192,192,0.3)',
            background: 'linear-gradient(135deg, rgba(192,192,192,0.06), rgba(184,134,11,0.03))',
          }}>
            ...
            {adMsg && (
              <div style={{
                ...
                background: adMsg.startsWith('✅') ? 'rgba(192,192,192,0.1)' : 'rgba(251,191,36,0.1)',
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div className="card" style={{
            ...
            {monetagMsg && (
              <div style={{
                marginTop: 10, padding: '8px 12px', borderRadius: 10, fontSize: 12, fontWeight: 600, textAlign: 'center',
                background: monetagMsg.startsWith('✅') ? 'rgba(192,192,192,0.1)' : 'rgba(251,191,36,0.1)',
        ...
        <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ animation: 'fadeIn 0.3s ease' }}>
                  ...
                  {orderMsg && (
                    <div style={{
                      ...
                      background: orderMsg.startsWith('✅') ? 'rgba(192,192,192,0.1)' : 'rgba(248,113,113,0.1)',
          ...
          {orderPayment && (
            <div className="card" style={{
              ...
              background: 'linear-gradient(135deg, rgba(192,192,192,0.08), rgba(16,185,129,0.03))',
              animation: 'fadeIn 0.3s ease'
            }}>
              ...
              <div style={{ marginBottom: 12 }}>
                ...
                <div onClick={() => { navigator.clipboard.writeText(orderPayment.memo); }} style={{
                  padding: '10px 12px', background: 'rgba(192,192,192,0.08)', borderRadius: 10,
              ...
              {payStatus && (
                <div style={{
                  marginBottom: 10, padding: '8px 12px', borderRadius: 10, fontSize: 12, fontWeight: 600, textAlign: 'center',
                  background: payStatus === 'completed' ? 'rgba(192,192,192,0.1)' : 'rgba(248,113,113,0.1)',
